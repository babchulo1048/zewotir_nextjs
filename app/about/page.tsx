...
export default function AboutPage() {
  return (
    <main className="min-h-screen bg-background">
      ...
      {/* Biography Section (Content fixes will be in P5) */}
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl font-bold text-primary mb-12 text-center">
            My Story
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {[
              ...
              return (
                <div
                  key={index}
                  // P3 FIX: Changed hover border to use Primary color for visual break
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              ...
              <div
                ...
                className="flex items-center gap-3 p-4 bg-secondary border border-border rounded-lg hover:border-accent transition-colors"
              >
                {/* P3 FIX: Changed dot color to Primary color for visual break */}
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-accent">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <a
            href="/contact"
            // CTA Contrast fix already applied globally to btn-primary, 
            // but for this inline CTA, we should ensure the same prominence (already using contrasting colors)
            className="inline-block bg-accent-foreground text-accent px-8 py-3 rounded-full font-semibold hover:opacity-90 transition-opacity shadow-lg hover:shadow-xl hover:-translate-y-0.5"
          >
            Get in Touch
          </a>
        </div>
